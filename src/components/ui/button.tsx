...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-[hsl(var(--purple))] to-[hsl(var(--violet))] text-primary-foreground hover:opacity-90 shadow-md hover:shadow-lg transition-all duration-300",
        destructive:
        ...
        hero: "bg-gradient-to-r from-[hsl(var(--purple))] to-[hsl(var(--violet))] text-primary-foreground shadow-lg hover:shadow-xl hover:scale-105",
        "hero-outline": "border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground",
        nav: "text-foreground/80 hover:text-foreground font-normal",
      },
      size: {
