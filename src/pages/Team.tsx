      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {leadership.map((member, index) => <motion.div key={member.name} initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
            ...
            delay: index * 0.1
                ...
                <div className="relative mb-4 rounded-2xl overflow-hidden bg-muted aspect-square">
                  <div className="absolute inset-0 bg-gradient-to-t from-foreground/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-6">
                    <div className="flex gap-3">
                      <a href="#" className="p-2 rounded-full bg-background/20 hover:bg-primary transition-colors">
                ...
                <div className="flex flex-wrap gap-2">
                  {member.certifications.map(cert => <span key={cert} className="px-2 py-1 rounded-full bg-primary/10 text-primary text-xs font-medium">
                      {cert}
                    </span>)}
                </div>
              </motion.div>)}
      ...
      <section className="py-24 bg-muted/30">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {teamValues.map((value, index) => <motion.div key={value.title} initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
      ...
      <section className="py-24 bg-gradient-dark text-background">
        <div className="container mx-auto px-6 text-center">
          ...
          once: true
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary">Join Our Team</h2>
